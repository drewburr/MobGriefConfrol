package com.github.drewburr.mobgriefcontrol.common;
...
import com.github.drewburr.mobgriefcontrol.common.error.BasicErrorReporter;
import com.github.drewburr.mobgriefcontrol.common.error.ErrorReporter;
import com.github.drewburr.mobgriefcontrol.common.error.ReportType;
...
public class PluginLibrary {
	...
	public static final ReportType REPORT_CANNOT_DELETE_CONFIG = new ReportType("Cannot delete old MobGriefControl configuration.");
	public static final ReportType REPORT_CANNOT_COPY_FILE = new ReportType("Cannot copy file.");

	public static final ReportType REPORT_PLUGIN_LOAD_ERROR = new ReportType("Cannot load MobGriefControl.");
	...
	public static final ReportType REPORT_PLUGIN_ENABLE_ERROR = new ReportType("Cannot enable MobGriefControl.");
